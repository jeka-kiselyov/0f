	...
	protected function validation()
	{
		return array(
				...
				array(
					'field'=>'code', 
					'checker' => checker_rules::MIN_LENGTH(1), 
					'error_message' => 'code is too short'
				),
				array(
					'field'=>'code', 
					'checker' => checker_rules::UNIQUE_IN_DB('i18n_languages', 'code', $this->id), 
					'error_message' => 'This code is already taken by another language'
				),
		);
	}
