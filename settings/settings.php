<?php
 ...
 $settings['version'] = require(SITE_PATH_SETTINGS.'version.php');
 ...
 // Minify settings
 $settings['css_version_suffix'] = 'suffix'; // suffix = 3123.version_number.css get = .css?v=version_number
 $settings['js_version_suffix'] = 'suffix'; // suffix = 3123.vversion_number.js get = .js?v=version_number
